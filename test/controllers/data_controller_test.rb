...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { category: @datum.category, downloaded: @datum.downloaded, path: @datum.path, source: @datum.source, wnid: @datum.wnid } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { category: @datum.category, downloaded: @datum.downloaded, path: @datum.path, source: @datum.source, wnid: @datum.wnid } }
